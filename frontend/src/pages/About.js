...
export const About = () => {
  ...
  return (
    <AboutSection>
      ...
      <p>
        This website was built in by Maria Thomasson as my final project at the Technigo coding bootcamp.
        The project is a combination between school and my new job and aims to create value to our customers.</p>
